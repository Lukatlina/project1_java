...
public class 상점 {
    ...
    private 음식물 샐러드 = new 음식물("샐러드", 8900, 5, 0, 0, 5 );
    private 음식물 케이크 = new 음식물("케이크", 7000, 20, 0,0,5);
    public void 상점아이템보기() {
    ...
    public void 음식물구매(개인연습생 플레이어, 음식물 변수명, List<음식물> 음식) {
        int 잔액 = 0;
    ...
    public void 음식물판매(개인연습생 플레이어, List<음식물> 음식물) {
