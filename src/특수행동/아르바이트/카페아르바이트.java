...
public class 카페아르바이트 extends 아르바이트 {
    ...
    public void 능력치습득(개인연습생 플레이어){
        ...
        if (랜덤값 == 0){
            ...
            System.out.println("일당 : " + (get일당()+7000) + "/ 체력 : -" + (get체력()+5) + "/ 보컬 : " + (get폐활량()+4) + "/ 랩 : " + (get화술()+4));
            ...
            System.out.println("일당 : " + (get일당()+2000) + "/ 체력 : -" + (get체력()+2) + "/ 보컬 : " + (get폐활량()+2) + "/ 랩 : " + (get화술()+2));
            ...
            System.out.println("일당 : " + get일당() + "/ 체력 : -" + get체력() + "/ 보컬 : " + get폐활량() + "/ 랩 : " + get화술());
